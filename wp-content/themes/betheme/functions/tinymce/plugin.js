		...
		editor.addButton('mfnsc', {
			...
			menu : [ {
				...
				menu : [ {
					...
					text : 'Image',
					onclick : function() {
						editor.insertContent('[image src="" align="" caption="" link="" link_image="" target="" alt="" border="0" greyscale="0" animate=""]');
					}
				}, {
					text : 'Popup',
					onclick : function() {
				...
				menu : [ {
					...
					text : 'Blog Slider',
					onclick : function() {
						editor.insertContent('[blog_slider title="" count="5" category="" category_multi="" more="0"]');
					}
				}, {
					text : 'Call to Action',
					onclick : function() {
					...
					text : 'Map',
					onclick : function() {
						editor.insertContent('[map lat="" lng="" height="200" zoom="13" icon="" title="" telephone="" email="" www=""]Insert your content here[/map]');
					}
				}, {
					text : 'Opening Hours',
					onclick : function() {
