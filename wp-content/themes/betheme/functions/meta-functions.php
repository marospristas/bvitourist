...
/*-----------------------------------------------------------------------------------*/
function mfn_builder_print_content( $post_id ){
...
// 	print_r($mfn_items);
	...
	if( mfn_opts_get('display-order') == 1 ) mfn_builder_print_content( $post_id );
...
// 			print_r($section['attr']);
	...
	// WordPress Editor Content -------------------------------------
	if( mfn_opts_get('display-order') == 0 ) mfn_builder_print_content( $post_id );
}
